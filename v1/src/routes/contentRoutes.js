...
const PAGE_LAYOUTS = {
	...
	SETWORLD: lazy(() => import('../pages/presentation/page-layouts/Blank')),
	ASIDE: lazy(() => import('../pages/presentation/aside-types/DefaultAsidePage')),
	MINIMIZE_ASIDE: lazy(() => import('../pages/presentation/aside-types/MinimizeAsidePage')),
};
const SET_WORLDS = {
	WORLD: lazy(() => import('../pages/presentation/set-worlds/World'))
...
const presentation = [
	...
	{
		path: `${layoutMenu.setWorld.path}/:id`,
		element: <SET_WORLDS.WORLD />,
		exact: true,
	},
	{
