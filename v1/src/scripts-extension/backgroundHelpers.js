...
const ScrapSlowFacebookFriends = async function (payload) {
  ...
  let serilizedDataNew = await serializeFBSlowFriendReq(payload.FBuserId, payload.dtsg, payload.cursor, payload.collectionToken);
  // let variables = {
  //   count: 8,
  //   scale: 1,
  //   search: null,
  ...
  // formData.append("doc_id", 3814944738571725);
