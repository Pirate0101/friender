    ...
    render() {
        return (
            ...
            <ul className="nav">
              ...
              <li className={this.props.selectedLink=='dashboard'?'nav-item active' : 'nav-item'} >
              ...
              <li className='nav-item' >
                ...
                <Collapse in={ this.state.basicUiMenuOpen }>
                  <ul className="nav flex-column sub-menu">
                    <li className="nav-item"> <Link className='nav-link' to="/basic-ui/buttons"><Trans>Buttons</Trans></Link></li>
                    <li className="nav-item"> <Link className='nav-link' to="/basic-ui/dropdowns"><Trans>Dropdowns</Trans></Link></li>
                    <li className="nav-item"> <Link className='nav-link' to="/basic-ui/typography"><Trans>Typography</Trans></Link></li>
                  </ul>
                </Collapse>
              </li>
              <li className='nav-item' >
                ...
                <Collapse in={ this.state.formElementsMenuOpen }>
                  <ul className="nav flex-column sub-menu">
                    <li className="nav-item"> <Link className='nav-link' to="/form-elements/basic-elements"><Trans>Basic Elements</Trans></Link></li>
                  </ul>
                </Collapse>
              </li>
              <li className='nav-item' >
                ...
                <Collapse in={ this.state.tablesMenuOpen }>
                  <ul className="nav flex-column sub-menu">
                    <li className="nav-item"> <Link className='nav-link' to="/tables/basic-table"><Trans>Basic Table</Trans></Link></li>
                  </ul>
                </Collapse>
              </li>
              <li className='nav-item' >
              ...
              <li className='nav-item' >
                ...
                <Collapse in={ this.state.userPagesMenuOpen }>
                  <ul className="nav flex-column sub-menu">
                    ...
                    <li className="nav-item"> <Link className='nav-link' to="/user-pages/lockscreen"><Trans>Lockscreen</Trans></Link></li>
                  </ul>
                </Collapse>
              </li>
              <li className='nav-item' >
